...
The app was created on React front-end, with sequelize express backend using MVC architecture.  Passport React JWT authorization is applied saving user data onto MongoDB.  
